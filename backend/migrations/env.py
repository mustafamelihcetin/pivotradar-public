...
# ── Path setup — app/ paketini import edilebilir yap ─────────────────────────
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from app.core.database import SQLALCHEMY_DATABASE_URL, Base  # noqa: E402

# Tüm modelleri import et — autogenerate'in tablolara görmesi için
...
# DATABASE_URL env'den oku; alembic.ini'deki sqlalchemy.url yerine kullan
